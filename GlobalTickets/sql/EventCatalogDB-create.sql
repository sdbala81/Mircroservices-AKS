...
UPDATE [Events] SET [Date] = '2021-05-23T12:01:42.3689706+02:00', [ImageUrl] = N'https://gillcleerenpluralsight.blob.core.windows.net/files/GlobalTickets/michael.jpg'
...
UPDATE [Events] SET [Date] = '2021-02-23T12:01:42.3670510+01:00', [ImageUrl] = N'https://gillcleerenpluralsight.blob.core.windows.net/files/GlobalTickets/banjo.jpg'
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'EventId', N'Artist', N'CategoryId', N'Date', N'Description', N'ImageUrl', N'Name', N'Price') AND [object_id] = OBJECT_ID(N'[Events]'))
    SET IDENTITY_INSERT [Events] ON;
INSERT INTO [Events] ([EventId], [Artist], [CategoryId], [Date], [Description], [ImageUrl], [Name], [Price])
VALUES ('1babd057-e980-4cb3-9cd2-7fdd9e525668', N'Many', 'fe98f549-e790-4e9f-aa16-18c2292a2ee9', '2021-06-23T12:01:42.3689889+02:00', N'The best tech conference in the world', N'https://gillcleerenpluralsight.blob.core.windows.net/files/GlobalTickets/conf.jpg', N'Techorama 2021', 400);
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'EventId', N'Artist', N'CategoryId', N'Date', N'Description', N'ImageUrl', N'Name', N'Price') AND [object_id] = OBJECT_ID(N'[Events]'))
    SET IDENTITY_INSERT [Events] OFF;
