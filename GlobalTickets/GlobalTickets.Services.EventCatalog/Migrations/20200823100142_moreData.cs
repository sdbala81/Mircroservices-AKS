    ...
    public partial class moreData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { new DateTime(2021, 5, 23, 12, 1, 42, 368, DateTimeKind.Local).AddTicks(9706), "https://gillcleerenpluralsight.blob.core.windows.net/files/GlobalTickets/michael.jpg" });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "Date", "ImageUrl" },
                values: new object[] { new DateTime(2021, 2, 23, 12, 1, 42, 367, DateTimeKind.Local).AddTicks(510), "https://gillcleerenpluralsight.blob.core.windows.net/files/GlobalTickets/banjo.jpg" });
