...
namespace GlobalTickets.Services.EventCatalog.DbContexts
{
    public class EventCatalogDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                ImageUrl = "https://gillcleerenpluralsight.blob.core.windows.net/files/GlobalTickets/banjo.jpg",
                CategoryId = concertGuid
            });
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                ImageUrl = "https://gillcleerenpluralsight.blob.core.windows.net/files/GlobalTickets/michael.jpg",
                CategoryId = concertGuid
            });
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                ImageUrl = "https://gillcleerenpluralsight.blob.core.windows.net/files/GlobalTickets/dj.jpg",
                CategoryId = concertGuid
            });
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                ImageUrl = "https://gillcleerenpluralsight.blob.core.windows.net/files/GlobalTickets/guitar.jpg",
                CategoryId = concertGuid
            });
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                ImageUrl = "https://gillcleerenpluralsight.blob.core.windows.net/files/GlobalTickets/conf.jpg",
                CategoryId = conferenceGuid
            });
