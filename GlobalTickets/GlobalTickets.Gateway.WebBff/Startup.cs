using AutoMapper;
using GlobalTickets.Gateway.WebBff.Services;
...
using System;
using GlobalTickets.Gateway.WebBff.Url;

namespace GlobalTickets.Gateway.WebBff
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "GlobalTickets Gateway BFF for Web API", Version = "v1" });
            });
        }
